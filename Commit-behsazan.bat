\\storage.behsazan.local\meymari\PortableGit\bin\git config --system http.sslverify false
...
\\storage.behsazan.local\meymari\PortableGit\bin\git -C \\storage.behsazan.local\meymari\Sandogh add "sp_fund_volume_chart.sql"
